...
const AttemptQuiz = ({ match }) => {
   ...
   useEffect(() => {
      const fetchQuiz = async () => {
         ...
         console.log('line 32: ', quizData.answers)
         setQuizAnswers(quizData.answers)
         console.log('AttemptedQuiz line 31: ', quizData.answers)
         setLoading(false)
         if (quizData.error) setQuizTitle(quizData.error)
            ...
            // console.log('AttemptedQuiz line 47 AttemptedQuestions: ', temp)
            setAttemptedQuestions(temp)
            // console.log(
            //    'AttemptedQuiz line 49 AttemptedQuestions: ',
            //    attemptedQuestions,
            // )
         }
      }
   ...
   const onNextQuestion = () => {
      if (playerAnswer == quizAnswers[currQuestionIndex]) {
         console.log('correct answer')
         //TODO: cool sound/effect for right answer
      } else {
         console.log('wrong answer')
         //TODO: cool sound/effect for wrong answer
      }
      setSelected('false')
