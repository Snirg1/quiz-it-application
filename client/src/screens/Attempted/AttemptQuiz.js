...
const AttemptQuiz = ({match}) => {
    ...
    // For Quiz not accessible
        ...
        const currPageQuestions = questions.slice(currQuestionIndex, currQuestionIndex + questionsPerPage)
        return (
            <div id="main-body">
                <div id="create-quiz-body">
                    ...
                    {currQuestionIndex !== questions.length - 1 && <button className="button wd-200" onClick={onNextQuestion}>
                        Next Question
                    </button>}
